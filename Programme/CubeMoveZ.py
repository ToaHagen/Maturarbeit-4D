#In diesem Programm wird die Animation der Translation eines Würfels in z-Dimension erstellt
...
def animate(i):
    ...
    plt.plot([-2,2],[0,0],color='white')

    #Malen des Bildes
    cube(0,0,
         -0.1*i, #Translation in Z
         0,0,0, 4,"c",Cube)
...
# anim.save('Saves/CubeMoveZ.mp4', writer=writer)
