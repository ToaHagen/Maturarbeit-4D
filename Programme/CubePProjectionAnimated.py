#Mit diesem Programm werden Bilder und Animationen erzeugt, die zeigen wie ein Würfel auf eine Leinwand projiziert wird.
#In der Animation dreht sich der Würfel

#Importierung der Bibliotheken
import numpy as np
import matplotlib.pyplot as plt
import matplotlib.animation as animation
#Definiton des Würfels mit Farben
Cube=[[[[1,1,1],  [1,1,-1],   'tab:blue'],
      ...
      [[-1,-1,1], 'tab:olive'],
      [[-1,-1,-1],'tab:cyan']]]
#Funktionen für die Rotation in den XY-Dimensionen
...
#Funktionen zur Erstellung der Leinwand
...
#Würfel und Leinwand gemeinsam drehen
def turnCube(cube,a):
...
def image(t):
    #Rotation von Würfel und Leinwand In Grad
    a=50 #50
    #Abstand des Beobachtungspunktes bei der Projektion von Würfel und Leinwand zum angezeigten Bild 
    v=-12 #-12 #-500

    # Der Würfel wird gedreht
    c=rotateCubeXY(Cube,(np.pi)*t/180) #(30)
...
#anim.save('Saves/CubeParallelProjection.mp4', writer=writer)
