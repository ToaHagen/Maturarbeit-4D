#Programm für Animation der Translation eines Tesseraktes in w-Dimension
...
def animate(i):
    ...
    tesseract(0,0,0,-0.1*i, (20+0),250,0,0,0,0, 4,8,"cc",ax)
...
# anim.save('Saves/TesseraktMoveW.mp4', writer=writer)
